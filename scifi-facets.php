...
add_action('wp_enqueue_scripts', function() {
  wp_register_script('scifi-facets', plugins_url('scifi-facets.js', __FILE__), array('jquery'), 0.4, TRUE);
  wp_enqueue_style('scifi-facets', plugins_url('scifi-facets.css', __FILE__), array(), 0.4);
});
